...
export interface ApiHomepageHomepage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Homeslider: Attribute.Component<'sliders.home-slider', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    maindescription: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    TheCEOMessage: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    CEOVideoUrl: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVisionAndMissionVisionAndMission extends Schema.SingleType {
  ...
  attributes: {
    ...
    visionintro: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    missionintro: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
